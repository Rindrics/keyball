...
const uint16_t PROGMEM combo_ent[]     = {KC_O,    KC_E,    COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [DVORAK_NICOLA] = LAYOUT_universal(
    ...
    KC_RSFT  , KC_SCLN , KC_Q    , KC_J    , KC_K    , KC_X    ,                                     KC_B     , KC_M    , KC_W    , KC_V    , KC_Z    , KC_RSFT  ,
                       LSG(KC_4) , KC_LGUI , KC_LALT , KC_LCTL , LT(NUMBER,KC_SLSH),        LT(SYMBOL,KC_TAB) , KC_SPC  ,           _______ , _______ , RGUI_T(KC_BSPC)
  ),
  ...
  [NUMBER] = LAYOUT_universal(
    ...
    _______  , S(KC_1) , S(KC_2) , S(KC_3) , S(KC_4) , S(KC_5) ,                                       S(KC_6) , S(KC_7) , S(KC_8) , S(KC_9) , S(KC_0) , _______  ,
                         _______ , _______ , _______ , _______ , _______ ,                  LT(SYMBOL,KC_BSLS) , _______ ,           _______ , _______ , _______
  ),
  ...
  [SYMBOL] = LAYOUT_universal(
    ...
    _______  , KC_LBRC , KC_RBRC  , KC_LABK , KC_RABK , KC_PLUS ,                                       _______ , _______ , _______ , _______  , _______ , _______ ,
                       LSG(KC_3)  , _______ , _______ , KC_EQL  , KC_BSLS ,                   _______ , _______ ,           _______ , _______  , _______
  ),
};
// clang-format on
